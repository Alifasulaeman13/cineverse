                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        @if ($ticket->status === 'pending')
                                            @php
                                                $showDate = \Carbon\Carbon::parse($ticket->showtime->show_date)->format('Y-m-d');
                                                $showTime = \Carbon\Carbon::parse($ticket->showtime->show_time)->format('H:i:s');
                                                $showDateTime = \Carbon\Carbon::parse($showDate . ' ' . $showTime);
                                                $canPay = $showDateTime->isFuture();
                                            @endphp
                                            @if ($canPay)
                                                <a href="{{ route('checkout.show', $ticket->id) }}" class="btn btn-success">
                                                    <i class="bi bi-credit-card"></i> Bayar Sekarang
                                                </a>
                                            @else
                                                <span class="badge bg-secondary py-2 px-3">Sudah Lewat</span>
                                            @endif
                                        @endif
                            ...
                            <div class="modal-content modal-dark">
                                ...
                                <div class="modal-body p-0">
                                    ...
                                    <div class="ticket-stub">
                                        <span class="ticket-stub-text">CineVerse</span>
                                    </div>
                                </div>
