...
@section('title', 'CineVerse - Nonton Film Favorit')
...
@else
    ...
    <section class="hero-section index-hero" style="background-image: url('https://via.placeholder.com/1920x600/0d111c/4c8aff?text=CineVerse+CINEMA'); background-size: cover; background-position: center; height: 75vh; min-height: 600px; position: relative; display: flex; align-items: flex-end;">
        ...
        <div class="container-fluid" style="position: relative; z-index: 2; padding-bottom: 4rem;">
            <div class="row">
                <div class="col-lg-6 offset-lg-1">
                    <h1 style="font-family: 'Pacifico', cursive; font-size: 4.5rem; text-shadow: 2px 2px 10px rgba(0,0,0,0.5); color: white;">CineVerse</h1>
