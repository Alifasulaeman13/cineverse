...
class BookingController extends Controller
{
    ...
    {
        // Get existing booking for the authenticated user
        $booking = Auth::user()->bookings()->with(['showtime.movie'])->findOrFail($bookingId);
        
        // Only allow viewing checkout for pending bookings
